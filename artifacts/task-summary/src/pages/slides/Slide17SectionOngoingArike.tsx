...
export default function Slide17SectionOngoingArike() {
    ...
    <div className="relative w-screen h-screen overflow-hidden" style={{ background: "#0C0C15", fontFamily: "var(--font-display-family)" }}>
      ...
      <div style={{ position: "absolute", right: 0, top: 0, bottom: 0, width: "42vw", background: "#FACB10" }}>
        ...
        <div style={{ ...s(0.7, "fadeInRight"), position: "absolute", bottom: "5vh", right: "4vw", textAlign: "right" }}>
          <span style={{ fontFamily: "var(--font-body-family)", fontSize: "1.5vw", color: "rgba(0,0,0,0.4)", letterSpacing: "0.1em" }}>5 Features</span>
        </div>
      </div>
      ...
      <div className="absolute flex flex-col justify-center" style={{ top: 0, left: "7vw", right: "44vw", bottom: 0 }}>
        ...
        <div style={{ ...s(0.65, "fadeInUp"), display: "flex", flexDirection: "column", gap: "1.2vh", marginTop: "4vh" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "1.2vw" }}>
            ...
            <span style={{ fontFamily: "var(--font-body-family)", fontSize: "1.85vw", color: "rgba(255,255,255,0.85)", fontWeight: 400 }}>Web CheckOut Arike</span>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: "1.2vw" }}>
            <div style={{ width: "0.6vw", height: "0.6vw", borderRadius: "50%", background: "#FACB10", flexShrink: 0 }} />
            <span style={{ fontFamily: "var(--font-body-family)", fontSize: "1.85vw", color: "rgba(255,255,255,0.85)", fontWeight: 400 }}>Arike SmartPicks</span>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: "1.2vw" }}>
            <div style={{ width: "0.6vw", height: "0.6vw", borderRadius: "50%", background: "#FACB10", flexShrink: 0 }} />
            <span style={{ fontFamily: "var(--font-body-family)", fontSize: "1.85vw", color: "rgba(255,255,255,0.85)", fontWeight: 400 }}>Inform — Significant Blocking</span>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: "1.2vw" }}>
            <div style={{ width: "0.6vw", height: "0.6vw", borderRadius: "50%", background: "#FACB10", flexShrink: 0 }} />
            <span style={{ fontFamily: "var(--font-body-family)", fontSize: "1.85vw", color: "rgba(255,255,255,0.85)", fontWeight: 400 }}>International Payment Gateway</span>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: "1.2vw" }}>
            <div style={{ width: "0.6vw", height: "0.6vw", borderRadius: "50%", background: "#FACB10", flexShrink: 0 }} />
            <span style={{ fontFamily: "var(--font-body-family)", fontSize: "1.85vw", color: "rgba(255,255,255,0.85)", fontWeight: 400 }}>90 Day Check on Arike</span>
          </div>
        </div>
      </div>
    </div>
