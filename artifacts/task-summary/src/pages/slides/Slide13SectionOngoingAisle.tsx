...
export default function Slide13SectionOngoingAisle() {
      ...
      <div className="absolute flex flex-col justify-center" style={{ top: 0, left: "7vw", right: "45vw", bottom: 0 }}>
        ...
        <div style={{ ...s(0.65, "fadeInUp"), display: "flex", flexDirection: "column", gap: "1.2vh", marginTop: "4vh" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "1.2vw" }}>
            ...
            <span style={{ fontFamily: "var(--font-body-family)", fontSize: "2vw", color: "rgba(255,255,255,0.85)", fontWeight: 400 }}>Web CheckOut Aisle</span>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: "1.2vw" }}>
            <div style={{ width: "0.6vw", height: "0.6vw", borderRadius: "50%", background: "rgba(255,255,255,0.5)", flexShrink: 0 }} />
            <span style={{ fontFamily: "var(--font-body-family)", fontSize: "2vw", color: "rgba(255,255,255,0.85)", fontWeight: 400 }}>Inform — Deleted Matches</span>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: "1.2vw" }}>
            <div style={{ width: "0.6vw", height: "0.6vw", borderRadius: "50%", background: "rgba(255,255,255,0.5)", flexShrink: 0 }} />
            <span style={{ fontFamily: "var(--font-body-family)", fontSize: "2vw", color: "rgba(255,255,255,0.85)", fontWeight: 400 }}>Multi Comment UX</span>
          </div>
        </div>
      </div>
