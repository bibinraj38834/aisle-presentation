      ...
      <div className="absolute flex flex-col justify-center" style={{ top: 0, left: "7vw", right: "44vw", bottom: 0 }}>
        ...
        <div style={{ ...s(0.65, "fadeInUp"), display: "flex", flexDirection: "column", gap: "1.2vh", marginTop: "4vh" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "1.2vw" }}>
            ...
            <span style={{ fontFamily: "var(--font-body-family)", fontSize: "1.85vw", color: "rgba(255,255,255,0.85)", fontWeight: 400 }}>Free for Female Phase 2 Events</span>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: "1.2vw" }}>
            <div style={{ width: "0.6vw", height: "0.6vw", borderRadius: "50%", background: "#FACB10", flexShrink: 0 }} />
            <span style={{ fontFamily: "var(--font-body-family)", fontSize: "1.85vw", color: "rgba(255,255,255,0.85)", fontWeight: 400 }}>Pop-up after Images Uploaded</span>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: "1.2vw" }}>
            <div style={{ width: "0.6vw", height: "0.6vw", borderRadius: "50%", background: "#FACB10", flexShrink: 0 }} />
            <span style={{ fontFamily: "var(--font-body-family)", fontSize: "1.85vw", color: "rgba(255,255,255,0.85)", fontWeight: 400 }}>Google Play Icon Visibility</span>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: "1.2vw" }}>
            <div style={{ width: "0.6vw", height: "0.6vw", borderRadius: "50%", background: "#FACB10", flexShrink: 0 }} />
            <span style={{ fontFamily: "var(--font-body-family)", fontSize: "1.85vw", color: "rgba(255,255,255,0.85)", fontWeight: 400 }}>Chat Tracking Task</span>
          </div>
        </div>
      </div>
    </div>
