...
export default function Slide16WebCheckoutArike() {
  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden" style={{ background: "#0C0C15", fontFamily: "var(--font-display-family)" }}>
      ...
      <div style={{ position: "absolute", top: "-10vh", left: "-5vw", width: "50vw", height: "50vh", background: "radial-gradient(ellipse, rgba(250,203,16,0.08) 0%, transparent 70%)", pointerEvents: "none" }} />
