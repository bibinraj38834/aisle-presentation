...
export default function Slide11SectionMinorAisle() {
      ...
      <div className="absolute flex flex-col justify-center" style={{ top: 0, left: "7vw", right: "45vw", bottom: 0 }}>
        ...
        <div style={{ ...s(0.65, "fadeInUp"), display: "flex", flexDirection: "column", gap: "1.2vh", marginTop: "4vh" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "1.2vw" }}>
            ...
            <span style={{ fontFamily: "var(--font-body-family)", fontSize: "2vw", color: "rgba(255,255,255,0.85)", fontWeight: 400 }}>Tracking Repeated Discover Profiles</span>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: "1.2vw" }}>
            <div style={{ width: "0.6vw", height: "0.6vw", borderRadius: "50%", background: "rgba(255,255,255,0.5)", flexShrink: 0 }} />
            <span style={{ fontFamily: "var(--font-body-family)", fontSize: "2vw", color: "rgba(255,255,255,0.85)", fontWeight: 400 }}>DS Signal for Google Ads</span>
          </div>
        </div>
      </div>

      <div style={{ ...s(0.8, "fadeInUp"), position: "absolute", bottom: "4vh", left: "7vw" }}>
        <span style={{ fontFamily: "var(--font-body-family)", fontSize: "1.5vw", color: "rgba(255,255,255,0.35)", letterSpacing: "0.1em" }}>2 Features</span>
      </div>
    </div>
  );
}
